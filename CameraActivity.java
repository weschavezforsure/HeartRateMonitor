...
public class CameraActivity extends AppCompatActivity {
    ...
    // Media player for heartbeat sound
    MediaPlayer mSound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heartView = (ImageView) findViewById(R.id.heartImg);
    ...
    protected void playSound() {
        ...
        mSound = MediaPlayer.create(this, R.raw.heartbeat);
        mSound.setOnCompletionListener(new OnCompletionListener(){

            @Override
            public void onCompletion(MediaPlayer mSound) {
    ...
    private void calcBPM() {
        ...
        Toast.makeText(getApplicationContext(), ("Heart Rate = " + mHeartRateInBPM + "BPM"), Toast.LENGTH_SHORT).show();
